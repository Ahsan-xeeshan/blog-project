      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          <h1 className="text-3xl font font-semibold text-center my-7">
            About Xeeshan&apos;s Blog
          </h1>
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Xeeshan&apos;s Blog! This blog was created by Nazmul
              Ahsan Xeeshan as a personal project to share his thoughts and
              ideas with the world. Sahand is a passionate developer who loves
